...
export function Hero() {
  const title = "Premium Tech Accessories"
    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        ...
        >
          ...
          >
            Explore our curated collection of high-quality tech accessories from South Africa
          </motion.p>
          ...
          >
            <Link href="/#products">
              ...
              >
                <span className="opacity-90 group-hover:opacity-100 transition-opacity">Explore Our Catalogue</span>

...
export const allProducts: Product[] = [
  ...
  {
    id: "Jokade-JA043-100W-Intelligent-Type-C-to-Type-C-Charging-Data",
    name: "Jokade JA043 100W Intelligent Type C to Type C",
    category: "Charger",
    image: "/premium-phone-case.jpg",
    description:
      "Fast and durable 100W Type-C to Type-C cable for quick charging and data transfer.",
    features: [
      "Supports up to 100W fast charging",
      "Type-C to Type-C compatibility",
      "High-speed data transmission",
      "Durable and tangle-free cable design",
      "Smart chip for stable power delivery",
      "1-meter length for convenient use",
    ],
    specifications: [
      { label: "Brand", value: "Jokade" },
      { label: "Model", value: "JA043" },
      { label: "Power Output", value: "100W Max" },
      { label: "Interface", value: "Type-C to Type-C" },
      { label: "Function", value: "Charging & Data Transfer" },
      { label: "Material", value: "Durable PVC Jacket" },
    ],
    inStock: true,
  },
  {
  ...
  {
    id: "Jokade-car-charger",
    name: "Jokade Car Charger",
    category: "Accessories",
    image: "/leather-phone-pouch-black.jpg",
    description:
      "Fast and reliable car charger for on-the-go power. Safe, efficient, and perfect for everyday use.",
    features: [
      "60W high-power output",
      "Dual-port fast charging (USB + Type-C)",
      "Overcharge and overheating protection",
      "PC fire-retardant material",
    ],
    specifications: [
      { label: "Brand", value: "Jokade" },
      { label: "Model", value: "JH027" },
      { label: "Power Output", value: "60W Max" },
      { label: "Ports", value: "USB + Type-C" },
      { label: "Material", value: "PC Fire Retardant" },
    ],
    inStock: true,
  },
  {
